...
metadata <- read_csv("data/SquidSequenced.csv", 
...
```{r}
### next 128 samples ###
C <- as.matrix(read.table("data/lc_pools/bcf_pools78/thin_100_1/pcangsd/YU_river-herring_output.cov"))
