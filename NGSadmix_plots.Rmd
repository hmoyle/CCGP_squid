...
all individuals with depths outside of the 90% majority are fully in one ancestral population (anyone below ~4x and above ~8x), though this does not include all samples that are fully in one ancestral population.